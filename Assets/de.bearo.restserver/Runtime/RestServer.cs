...
namespace RestServer {
    ...
    public class RestServer : MonoBehaviour, ISerializationCallbackReceiver {
        ...
        /// </summary>
        [Tooltip("Maximum number of ThreadingHelper workloads to be processed per frame. Default = 5. " +
                 "If set to zero the workload from the ThreadingHelper will not be processed.")]
