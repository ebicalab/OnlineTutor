...
namespace RestServer.Helper {
    ...
    public class ResponseBuilder {
        ...
        /// </summary>
        public ResponseBuilder BodyJson(object obj, string contentType = null) {
            if (contentType != null) {
        ...
        /// </summary>
        public ResponseBuilder Body(string body, string contentType = null) {
            if (contentType != null) {
                _header.withOverwriteHeader(HttpHeader.CONTENT_TYPE, contentType);
            } else {
                _header.withSetIfNotExists(HttpHeader.CONTENT_TYPE, MimeType.TEXT_PLAIN_UTF_8);
            }
        ...
        /// </summary>
        public ResponseBuilder Body(byte[] body, string contentType = null) {
            if (contentType != null) {
                _header.withOverwriteHeader(HttpHeader.CONTENT_TYPE, contentType);
            } else {
                _header.withSetIfNotExists(HttpHeader.CONTENT_TYPE, MimeType.APPLICATION_OCTET_STREAM);
            }
        ...
        /// </summary>
        public void ScheduleInternalRedirect(string endpointPath, object ignoreTag = null) {
            ...
            _request.RedirectHelper.IgnoreTag = ignoreTag;
